...
BUILTIN_REWARD_MODULES = {
    "sparse_exit": "env_diy.rewards.sparse_exit",
    "collect_key": "env_diy.rewards.collect_key",
    "collect_gold": "env_diy.rewards.collect_gold",
    "kill_monster": "env_diy.rewards.kill_monster",
    "exploration": "env_diy.rewards.exploration",
}
...
def load_reward(
    *,
    ...
    if not isinstance(reward, BaseReward):
        raise TypeError(
            "make_reward(**kwargs) must return an instance of env_diy.rewards.base.BaseReward"
        )
    return reward
